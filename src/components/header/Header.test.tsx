...
describe('Header', () => {
  ...
  it('renders Header component correctly', () => {
    ...
    expect(screen.getByRole('link', { name: /Nosso espaço/i })).toBeInTheDocument();
    expect(screen.getByRole('link', { name: /Nossos Planos/i })).toBeInTheDocument();
    expect(screen.getByRole('link', { name: /Nossa Equipe/i })).toBeInTheDocument();
    expect(screen.getByRole('link', { name: /Contato/i })).toBeInTheDocument();
  });

  it('toggles menu state when MenuButton is clicked', () => {
    const { container } = customRender(<Header />);
    const menuButton = container.querySelector('.menu-button') as HTMLLabelElement;
